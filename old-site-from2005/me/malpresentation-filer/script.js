...
var ENDSHOW_MESG="Bildspelet är slut, klicka för att avsluta.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=7, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var sNext="Nästa",sPrev="Föregående",sEnd="Avsluta bildspel",sFont="Arial"
function ShowMenu()
{
	BuildMenu();
